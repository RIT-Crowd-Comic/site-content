        ...
        return (
            <div id="fillTools" className={styles.toolStyles}>
                ...
                <div id={styles.paletteButtons}>
                    ...
                    <button onClick={() => changeFillColor(color1)} id={styles.whiteButton} />
                    <button onClick={() => changeFillColor(color2)} id={styles.lightGrayButton} />
                    <button onClick={() => changeFillColor(color3)} id={styles.grayButton} />
                    <button onClick={() => changeFillColor(color4)} id={styles.darkGrayButton} />
                    <button onClick={() => changeFillColor(color5)} id={styles.blackButton} />
                </div>
            </div>
        );
    }

...
const TextOptions = ({enabled, changeTextContent, changeTextFont, changeTextSize, changeFontWeight, changeTextAlignment, changeTextColor} : Props) =>
{
    ...
    {
        let buttonSelected = document.querySelector("input[name='fontWeight']:checked") as HTMLInputElement;
        ...
        return(
            <div id="textTools">
                ...
                <div id="textFont">
                    ...
                    <select id="fontSelect" className="form-select" ref={fontDropdownReference} onChange={updateFont} defaultValue="2">
                ...
                <div id="textSize">
                    <select id="sizeSelect" className="form-select" ref={sizeDropdownReference} onChange={updateSize} defaultValue="12">
                ...
                <div id="textWeight">
                    ...
                    <div id="bold">
                        <input type="radio" name="fontWeight" id="boldSelect" value="bold" onChange={updateWeight}/>
                        <label htmlFor="boldSelect">Bold</label>
                    </div>

                    <div id="italic">
                        <input type="radio" name="fontWeight" id="italicSelect" value="italic" onChange={updateWeight}/>

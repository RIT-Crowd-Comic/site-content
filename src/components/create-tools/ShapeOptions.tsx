...
const ShapeOptions = ({
    enabled, shapeBorderSize, changeShapeBorderSize, changeShapeBorderColor, changeShapeFillColor, changeShape, changeDashedBorder
} : Props) => {
    ...
    */
    ...
    function updateShape(index:number) {
        const buttonSelected = document.querySelector("input[name='shape']:checked") as HTMLInputElement;
    ...
    function updateDashedBorder() {
        const checkBox = document.querySelector('#dashedBorderToggle') as HTMLInputElement;
        ...
        return (
            <div id="shapeTools" className={styles.toolStyles}>
                    ...
                    <div id={styles.rectangleSelect}>
                        <label id={styles.rectangle} htmlFor="rectangle" className={shapeChosen[0]} >
                            <input
                                ...
                                name="shape"
                                id="rectangle"
                                value={shapeStates.RECTANGLE}
                                defaultChecked
                                onChange={() => updateShape(0)}
                            />
                        </label>
                    </div>
                    ...
                    <div id={styles.lineSelect}>
                        <label id={styles.line} htmlFor="line" className={shapeChosen[1]}>
                            <input
                                ...
                                name="shape"
                                id="line"
                                value={shapeStates.LINE}
                                onChange={() => updateShape(1)}
                            />
                        </label>
                    </div>
                    ...
                    <div id={styles.ellipseSelect}>
                        <label id={styles.ellipse} htmlFor="ellipse" className={shapeChosen[2]}>
                            <input
                                ...
                                name="shape"
                                id="ellipse"
                                value={shapeStates.ELLIPSE}
                                onChange={() => updateShape(2)}
                            />
                        </label>
                    </div>
                    <div id={styles.triangleSelect}>
                        <label id={styles.triangle} htmlFor="triangle" className={shapeChosen[3]}>
                            <input
                                ...
                                name="shape"
                                id="triangle"
                                value={shapeStates.TRIANGLE}
                                onChange={() => updateShape(3)}
                            />
                        </label>
                    </div>
                    <div id={styles.hexagonSelect}>
                        <label id={styles.hexagon} htmlFor="hexagon" className={shapeChosen[4]}>
                            <input
                                ...
                                name="shape"
                                id="hexagon"
                                value={shapeStates.HEXAGON}
                                onChange={() => updateShape(4)}
                            />
                        </label>
                    </div>
                    <div id={styles.octagonSelect}>
                        <label id={styles.octagon} htmlFor="octagon" className={shapeChosen[5]}>
                            <input
                                ...
                                name="shape"
                                id="octagon"
                                value={shapeStates.OCTAGON}
                                onChange={() => updateShape(5)}
                            />
                        </label>
                    </div>
                    <div id={styles.starSelect}>
                        <label id={styles.star} htmlFor="star" className={shapeChosen[6]}>
                            <input
                                ...
                                name="shape"
                                id="star"
                                value={shapeStates.STAR}
                                onChange={() => updateShape(6)}
                            />
                        </label>
                    </div>
                </div>
                <div id={styles.shapeBorderSlider} className="toolSlider">
                    ...
                    <div id={styles.progressBar} style={{ width: `${shapeBorderSize * 3.32 + 1}%` }} onChange={updateSize} />
                    <input
                        type="range"
                        min="1"
                        max="20"
                ...
                <div id={styles.borderPaletteButtons}>
                    ...
                    <button onClick={() => changeShapeBorderColor(color1)} id={styles.whiteButton} />
                    <button onClick={() => changeShapeBorderColor(color2)} id={styles.lightGrayButton} />
                    <button onClick={() => changeShapeBorderColor(color3)} id={styles.grayButton} />
                    <button onClick={() => changeShapeBorderColor(color4)} id={styles.darkGrayButton} />
                    <button onClick={() => changeShapeBorderColor(color5)} id={styles.blackButton} />
                    <button onClick={() => changeShapeBorderColor(color6)} id={styles.emptyButton} />
                </div>
                <div id={styles.fillPaletteButtons}>
                    <label id="colorLabel">Fill:</label>
                    <button onClick={() => changeShapeFillColor(color1)} id={styles.whiteButton} />
                    <button onClick={() => changeShapeFillColor(color2)} id={styles.lightGrayButton} />
                    <button onClick={() => changeShapeFillColor(color3)} id={styles.grayButton} />
                    <button onClick={() => changeShapeFillColor(color4)} id={styles.darkGrayButton} />
                    <button onClick={() => changeShapeFillColor(color5)} id={styles.blackButton} />
                    <button onClick={() => changeShapeFillColor(color6)} id={styles.emptyButton} />
                </div>
            </div>
        );
    }

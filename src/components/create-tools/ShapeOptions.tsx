        ...
        return(
            <div id="shapeTools" className={styles.toolStyles}>
                ...
                <div id={styles.shapeBorderSlider} className="toolSlider">
                    ...
                    <input type="range" min="1" max="20" defaultValue={shapeBorderSize} step="1" id="shapeBorderRange" className={styles.rangeSlider}  ref={sliderReference} onChange={updateSize}></input>
                </div>
                <div id="dashedBorder">

                  ...
                  <div className='filterOpt d-grid gap-3 d-md-flex justify-content-center'>
                      ...
                      <div className="input-group" aria-label="Searchbox">
                          <div className="form-outline" data-mdb-input-init>
                            <input id="search-input" type="search" className={`${styles.formControl} form-control mt-1 px-5 py-2`} placeholder='Searching for...' onChange={(e) => setSearchInput(e.target.value)}/>
                          </div>
                          <button id="search-button" type="submit" className="btn btn-outline-dark btn-secondary px-3 mt-1" onClick={handleSearchClick}>
                            <Image className="searchbar p-2" src={search} alt="Searchbar" fill={true}/>
                          </button>
                        {/* </div> */}
                      </div>
                      {/* Role */}
                      <select className={`${styles.formSelect} form-select role m-1`} aria-label="Role Filter">
                      ...
                      {/* Year */}
                      <select className={`${styles.formSelect} form-select year m-1`} aria-label="Year Filter">

                  ...
                  <div className='filterOpt d-grid gap-3 d-md-flex justify-content-center'>
                      ...
                      <div className="input-group flex-wrap" aria-label="Searchbox">
                          <div className="form-outline" data-mdb-input-init>
                            <input id="search-input" type="search" className={`${styles.formControl} form-control mt-1 px-5 py-2`} placeholder='Search by name...' onChange={(e) => setSearchInput(e.target.value)}/>
                          </div>
